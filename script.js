...
(function initThree() {
    ...
    webgl.texturesOptions = [
        ...
        { index: 4, texture: "image", quote: '&nbsp;&nbsp;“ Euegnio Dalli Cardillo , <span style="color:#f81b1b">Leverage over 12 years of event and marketing expertise to elevate your brand and drive revenue growth."</span> ', threshold: 80, random: 1.0, depth: 4.0, maxDepth:120, size: 1.5, square: 0 },
